...
namespace AeternumGames.Chisel.Import.Source.Editor
{
    ...
    public partial class ChiselSource2006MapImporterWindow : EditorWindow
    {
        ...
        private static ChiselSource2006MapImporterWindow window;
        ...
        [MenuItem("Assets/Chisel/Import Source VMF")]
        private static void Init()
        {
            window = EditorWindow.GetWindow<ChiselSource2006MapImporterWindow>( true );
        }
        ...
        private void ImportValveMapFormat2006()
        {
            ...
            try
            {
                ...
                if( pickedVMF.Length != 0 )
                {
                    ...
                    ValveMapFormat2006.VmfWorldConverter.Import( ChiselModelManager.CreateNewModel( go.transform ), map, SourceGame.GetVPKPathsForTitle( m_Game ) );
